...
<div class="grids">
    <div class="daycare">
        <img src="img/daycare.jpg" height="250" width="350" alt="picture">
    ...
    <div class="petWalking">
        <img src="img/petWalking.jpg" height="250" width="350" alt="picture">
        ...
        <p>This service keeps us focused on your pet's health, trains your pet, and visits the vet if needed. If you need to find more
            information, you can <a href="petWalking.php.php"><strong>click here</strong></a></p>
    </div>

    <div class="petSitting">
        <img src="img/petSitting.jpg" height="250" width="350" alt="picture">
