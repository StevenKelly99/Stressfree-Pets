...
<div class="grids">
    <div class="daycare">
        <a href="daycare.php">
            <img src="../images/daycare.jpg" height="250" width="350" alt="picture"></a>
    ...
    <div class="petWalking">
        <a href="PetWalking.php">
            <img src="../images/petWalking.jpg" height="250" width="350" alt="picture"></a>
    ...
    <div class="petSitting">
        <a href="petsitting.php">
            <img src="../images/petSitting.jpg" height="250" width="350" alt="picture"></a>
